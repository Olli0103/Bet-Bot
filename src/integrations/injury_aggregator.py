...
async def _fetch_rss(sport: str, team_names: List[str]) -> List[Dict[str, str]]:
    ...
    Kept as a dedicated RSS-only call — fast, free, no API quota burn.
    The broader cascade (GNews/NewsData/NewsAPI) runs via _fetch_multi_news.
    """
